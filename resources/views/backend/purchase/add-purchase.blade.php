...
<script id="document-template" type="text/x-handlebars-template">
  <tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
      <input type="number" min="1" class="form-control form-control-sm text-right buying_qyt" name="buying_qyt[]" value="1">
    </td>
    <td>
...
<script type="text/javascript"> 
  $(document).ready(function () {
    ...
    $(document).on('keyup click','.unit_price,.buying_qyt',function(){
    var unit_price = $(this).closest("tr").find("input.unit_price").val();
    var qty = $(this).closest("tr").find("input.buying_qyt").val();
