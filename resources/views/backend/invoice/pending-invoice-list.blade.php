                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          @elseif($invoice->status='1')
                            <span style="background: #5EABOO; padding: 5px;">Approved</span>
                          @endif
                         </td>
                       <td>
                        @if($invoice->status=='0')
                         <a title="Approve" class="btn btn-sm btn-success" href="{{route('invoice.approve',$invoice->id)}}"><i class="fa fa-check-circle"></i></a>
                         <a title="delete" id="delete" class="btn btn-danger" href="{{route('invoice.delete', $invoice->id)}}"><i class="fa fa-trash"></i></a>
                        @endif
                       </td>
                      </tr>
                    @endforeach
