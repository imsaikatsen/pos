              ...
              <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" name="invoice_no"  id="invoice_no" class="form-control form-control-sm" value="{{$invoice_no}}" readonly style="background-color:#10e0c5">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                     ...
                     <div class="form-group col-md-2">
                      ...
                      <input type="text" name="current_stock_qty" id="current_stock_qty" class="form-control form-control-sm" readonly style="background-color:#10e0c5">
                    </div>

                    <div class="form-group col-md-2" style="padding-top: 30px;" >
                      <a class="btn btn-primary addeventmore"><i class="fa fa-plus-circle"></i> Add</a>
                  </div>
                  ...
                  <table class="table-sm table-bordered" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="text" name="estimate_ammount" value="0" id="estimate_ammount" class="form-control form-control-sm text-right estimate_ammount" readonly style="background-color:#10e0c5">
                        </td>
                        <td></td>
                      </tr>
                    </tbody>  
...
<script type="text/javascript"> 
  ...
  //calculate the sum of ammount in invoice
